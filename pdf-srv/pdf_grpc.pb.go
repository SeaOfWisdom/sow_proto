...
func (c *pdfServiceClient) MakeScientificPaper(ctx context.Context, in *ScientificPaperRequest, opts ...grpc.CallOption) (*ScientificPaperResponse, error) {
	...
	err := c.cc.Invoke(ctx, PdfService_MakeScientificPaper_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pdfServiceClient) MakeScientificPaperLatex(ctx context.Context, in *ScientificPaperRequest, opts ...grpc.CallOption) (*ScientificPaperResponse, error) {
	out := new(ScientificPaperResponse)
	err := c.cc.Invoke(ctx, PdfService_MakeScientificPaperLatex_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PdfService_MakeScientificPaper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PdfService_MakeScientificPaper_FullMethodName,
	}
...
func _PdfService_MakeScientificPaperLatex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PdfService_MakeScientificPaperLatex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
