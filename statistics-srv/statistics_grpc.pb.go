...
func (c *statisticServiceClient) GetStatistics(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Statistics, error) {
	out := new(Statistics)
	err := c.cc.Invoke(ctx, "/pp.statistics.StatisticService/GetStatistics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statisticServiceClient) StoreBatchTransaction(ctx context.Context, in *TransactionLogs, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/pp.statistics.StatisticService/StoreBatchTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statisticServiceClient) GetPurchasedWork(ctx context.Context, in *WorkIDsList, opts ...grpc.CallOption) (*GetPurchasedWorkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pp.statistics.StatisticService/GetPurchasedWork", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatisticService_GetStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pp.statistics.StatisticService/GetStatistics",
	}
...
func _StatisticService_StoreBatchTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pp.statistics.StatisticService/StoreBatchTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatisticService_GetPurchasedWork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pp.statistics.StatisticService/GetPurchasedWork",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
